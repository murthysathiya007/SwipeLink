...
class SubscriptionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $startDate = Carbon::createFromFormat($php_date_format, $request->start_date)->format('Y-m-d');
        $endDate = Carbon::createFromFormat($php_date_format, $request->end_date)->format('Y-m-d');
