        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('settings.security.store') }}" class="form-submit-event" method="POST">
                    <input type="hidden" name="redirect_url" value="{{ route('security.index') }}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="max_login_attempts"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="time_decay" placeholder="Enter time decay"
