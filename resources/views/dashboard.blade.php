    ...
    <div class="container-fluid">
        <div class="col-lg-12 col-md-12 order-1">
            <div class="row mt-4">
                    ...
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ getDefaultViewRoute('projects') }}"><small class="text-success fw-semibold"><i
                    ...
                    <div class="col-lg-3 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{ getDefaultViewRoute('tasks') }}"><small class="text-primary fw-semibold"><i
                                            class="bx bx-right-arrow-alt"></i><?= get_label('view_more', 'View more') ?></small></a>
                            </div>
                        </div>
                    </div>
                ...
                @else
                    {{-- Meetings Stats --}}
                    @if ($auth_user->can('manage_meetings'))
                        <div class="col-lg-3 col-md-12 col-6 mb-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <div class="avatar flex-shrink-0">
                                            <i
                                                class="menu-icon tf-icons bx bx-shape-polygon text-success bx-md text-warning"></i>
                                        </div>
                                    </div>
                                    <span
            ...
            <div class="row">
                ...
                @if ($auth_user->hasRole('admin') || $auth_user->can('manage_projects'))
